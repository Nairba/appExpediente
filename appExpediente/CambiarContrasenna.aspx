<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CambiarContrasenna.aspx.cs" Inherits="appExpediente.CambiarContrasenna" %>
        ...
        <div class="container-login100">
            <div class="wrap-login100 p-t-50 p-b-90">
                ...
                <form class="login100-form validate-form flex-sb flex-w" id="form1" runat="server">
                    <span class="login100-form-title p-b-51">Inicias Seción
                    </span>
                    ...
                    <div class="wrap-input100 validate-input m-b-16" data-validate="Contraseña requerida">
                        <asp:TextBox ID="txtContrasenna1"
                    ...
                    <div class="wrap-input100 validate-input m-b-16" data-validate="Confirmar contraseña requerida">
